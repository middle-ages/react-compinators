...
When building a family of variants from a base component, for example, besides
building the various variants, there is the issue of _import ergonomics_.
...
Which you could import and use with:
...
export const QuestionLabel = pipe('?', String.concat, modProp(BaseLabel, 'text'))
