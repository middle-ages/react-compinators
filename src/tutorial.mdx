...
export const Component = pipe(Label, renameProp('textColor', 'color'))

<fieldset>
<legend><code>renamePropTextColorColor(Label)</code></legend>
<Component textColor="pink" text="Hello World!" />
</fieldset>
